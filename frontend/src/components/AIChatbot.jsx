...
{
role: "ai",
text: "Hi! I'm ZenzBot. How can I help you with your shopping today?",
},
]);
...
try {
  ...
  setMessages((prev) => [
    ...
    {
      role: "ai",
      text: "Sorry, I'm having trouble connecting. Try again later!",
    },
  ]);
} finally {
  setIsLoading(false);
...
>
{isOpen ? <AiOutlineClose size={24} /> : <AiOutlineRobot size={24} />} </button>

  {/* Chat Window */}
  {isOpen && (
    <div className="absolute bottom-16 right-0 w-80 md:w-96 bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
